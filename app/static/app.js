...
(function () {
  ...
  // ===================== MODALS ===========================================
  const MODAL_WIDTH = { taskDetail: "max-w-3xl", team: "max-w-2xl", manageStakeholders: "max-w-2xl", sprintManage: "max-w-2xl" };
  ...
  const MODALS = {
    ...
    manageStakeholders: () => {
      ...
      return `
        ...
        <div class="pt-4 border-t border-slate-800">
          <p class="text-[11px] font-bold uppercase tracking-wider text-slate-500 mb-3">Register stakeholder</p>
